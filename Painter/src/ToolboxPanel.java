...
import custom.ColorOptionButtonControl;
...
public class ToolboxPanel extends JPanel {
	...
	private ColorOptionButtonControl mColorOneTwoControl;
	...
	private void addColorsSection() {
		...
		mColorOneTwoControl = new ColorOptionButtonControl();
					...
					colorButton.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							if (mCurrentShape != null) {
								...
								mColorOneTwoControl.setColor(colorButton.getBackground());
							} else {
							}
						}
					});
		...
		colorMainPanel.add(mColorOneTwoControl);
